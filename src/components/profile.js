...
const Profile = ({ isOpen }) => {
  ...
  const [Relatively, setRelatively] = useState(false);
              ...
              <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                <form onSubmit={handleSubmit}>
                  <h6 class="text-blueGray-400 text-sm mt-3 mb-6 uppercase">
                    <span className='font-bold'>SECTION One: </span>Personal Details
                  </h6>
                  <div class="flex flex-wrap">
                    ...
                    <div class="w-full lg:w-4/12 px-6">
                      <div className="w-full mb-3">
                        <label className="block uppercase text-blueGray-600 text-xs mb-2" htmlFor="gender">
                          Gender :
                        </label>
                        <select
                          id="gender"
                    ...
                    <div class="w-full lg:w-4/12 px-6">
                      <div className="w-full mb-3">
                        <label className="block uppercase text-blueGray-600 text-xs mb-2" htmlFor="salutation">
                          Salutation :
                        </label>
                        <select
                          id="salutation"
                    ...
                    <div class="w-full lg:w-4/12 px-6">
                      <div class="w-full mb-3">
                        <label class="block uppercase text-blueGray-600 text-xs mb-2" htmlFor="birthDate">
                          Date of Birth :
                        </label>
                        <input
                          type="date"
                    ...
                    <div class="w-full lg:w-4/12 px-6">
                      <div class="w-full mb-3">
                        <label class="block uppercase text-blueGray-600 text-xs mb-2" htmlFor="ethnicity">
                          Ethnicity :
                        </label>
                    ...
                    <div class="w-full lg:w-4/12 px-6">
                      <div class="w-full mb-3">
                        <label class="block uppercase text-blueGray-600 text-xs mb-2" htmlFor="disabilityStatus">
                          Disability Status :
                        </label>
                        <select
                  ...
                  <div class="w-full lg:w-4/12 px-6">
                    ...
                    <div className="w-full lg:w-4/12 px-6">
                      <div className="w-full mb-3">
                        <label className="block uppercase text-blueGray-600 text-xs mb-2" htmlFor="HomeCounty">
                          Home county :
                        </label>
                        <select
                    ...
                    <div className="w-full lg:w-4/12 px-6">
                      <div className="w-full mb-3">
                        <label className="block uppercase text-blueGray-600 text-xs mb-2" htmlFor="SubCounty">
                          Sub-County :
                        </label>
                        <select
                  ...
                  <h6 class="text-blueGray-400 text-sm mt-3 mb-6 uppercase">
                    <span className='font-bold'>SECTION TWO:</span> Current public institution Category
                  </h6>
                  <div class="flex flex-wrap">
                    ...
                    <div class="w-full lg:w-4/12 px-6 ">
                      <div class="w-full mb-3">
                        <label class="block uppercase text-blueGray-600 text-xs mb-2" htmlFor="appointmentDate">
                    ...
                    <div class="w-full lg:w-4/12 px-6">
                      <div class="w-full mb-3">
                        <label class="block uppercase text-blueGray-600 text-xs mb-2" htmlFor="prevAppointmentDate">
