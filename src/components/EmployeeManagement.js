...
// import {  setEmployeeRoles } from "../redux/Leave/LeaveSlice";
...
//     const currentItems = empRoles.users && empRoles.users.slice(indexOfFirstItem, indexOfLastItem);
...
//             <div className="absolute top-[9%] left-[25%] border-2 border-red-900 w-[60%]">
//                 {loading && <p>Loading...</p>}
...
//                                         <button onClick={() => handleEditClick(user)} className="bg-blue-500 text-white p-2 rounded-lg">< FaPen/></button>
//                                     </td>
//                                 </tr>
//                             ))
//                         ) : (
//                             <tr>
//                                 <td className='px-6 py-3' colSpan="5">No employees found</td>
//                             </tr>
//                         )}
//                     </tbody>
//                 </table>
...
//                         Page {currentPage} / {Math.ceil(empRoles.users.length / itemsPerPage)}
//                     </span>
//                     <button onClick={() => paginate(currentPage + 1)} disabled={indexOfLastItem >= empRoles.users.length}>
//                         <FaArrowRight />
//                     </button>
//                 </div>
