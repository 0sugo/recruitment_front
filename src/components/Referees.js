          ...
          <div className="flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-white border-0">
            <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
              <form onSubmit={handleSubmit}>
                ...
                <span className='font-bold text-black'>SECTION seven: </span>FIRST REFEREE
                ...
                <div class="flex flex-wrap">
                  ...
                  <div class="w-full lg:w-6/12 px-6">
                    <div class="w-full mb-3">
                      <label class="block uppercase text-blueGray-600 text-xs  mb-2" htmlfor="grid-password">
                        Period for which the referee has known you ( Yrs):
                      </label>
                ...
                <h6 class="text-red-600 text-sm mt-3 mb-6 font-bold uppercase">
                <span className='font-bold text-black'>SECTION seven: </span> SECOND REFEREE
